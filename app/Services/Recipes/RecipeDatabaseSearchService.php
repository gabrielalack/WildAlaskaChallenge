...
class RecipeDatabaseSearchService implements RecipeSearchInterface
{
    ...
    /**
     * Retrieve a single recipe from the database by id
     */
    public function getById(int $recipeId): RecipeDisplayResource
    {
        return new RecipeDisplayResource(Recipe::findOrFail($recipeId));
    }
}